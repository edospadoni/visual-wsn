...
Blockly.Blocks['procedures_defnoreturn'] = {
  ...
  compose: function(containerBlock) {
    ...
    while (paramBlock) {
      ...
      this.types_.push(paramBlock.getFieldValue('TYPE'));
...
Blockly.Blocks['procedures_defreturn_integer'] = {
  init: function() {
  ...
  getProcedureDef: function() {
    return [this.getFieldValue('NAME'), this.arguments_, 'int'];
  },
  getVars: Blockly.Blocks['procedures_defnoreturn'].getVars,
  renameVar: Blockly.Blocks['procedures_defnoreturn'].renameVar,
  customContextMenu: Blockly.Blocks['procedures_defnoreturn'].customContextMenu,
  callType_: 'procedures_callreturn_integer'
};
...
Blockly.Blocks['procedures_defreturn_boolean'] = {
   ...
   */
  getProcedureDef: function() {
    return [this.getFieldValue('NAME'), this.arguments_, 'bool'];
  },
  getVars: Blockly.Blocks['procedures_defnoreturn'].getVars,
  renameVar: Blockly.Blocks['procedures_defnoreturn'].renameVar,
  customContextMenu: Blockly.Blocks['procedures_defnoreturn'].customContextMenu,
  callType_: 'procedures_callreturn_boolean'
};
...
Blockly.Blocks['procedures_defreturn_string'] = {
   ...
   */
  getProcedureDef: function() {
    return [this.getFieldValue('NAME'), this.arguments_, 'string'];
  },
  getVars: Blockly.Blocks['procedures_defnoreturn'].getVars,
  renameVar: Blockly.Blocks['procedures_defnoreturn'].renameVar,
  customContextMenu: Blockly.Blocks['procedures_defnoreturn'].customContextMenu,
  callType_: 'procedures_callreturn_string'
};
...
Blockly.Blocks['procedures_mutatorarg'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["integer", "short"], ["boolean", "boolean"], ["string", "String"]]), "TYPE")
...
Blockly.Blocks['procedures_callreturn_integer'] = {
  /**
...
Blockly.Blocks['procedures_callreturn_boolean'] = {
  /**
   * Block for calling a procedure with a return value.
   * @this Blockly.Block
   */
...
Blockly.Blocks['procedures_callreturn_string'] = {
  /**
   * Block for calling a procedure with a return value.
   * @this Blockly.Block
   */
